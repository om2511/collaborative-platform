      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
          ...
          <div className="lg:col-span-2">
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-primary-500 focus:border-primary-500 text-gray-900 placeholder-gray-500"
        ...
        {(filters.search || filters.status || filters.priority || filters.category) && (
          <div className="mt-4 flex items-center justify-between">
            ...
            <Button variant="outline" size="sm" onClick={clearFilters} className="text-gray-900 hover:text-white">
              Clear filters
            </Button>
          </div>
        )}
