        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 relative">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Describe your idea in detail, including benefits and potential impact..."
            />
            {errors.description && (
          ...
          <div>
            ...
            <input
              ...
              type="text"
              className="w-full px-4 py-3 border border-gray-200/50 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 placeholder-gray-400 bg-white/50 backdrop-blur-sm"
              placeholder="innovation, user-experience, mobile (comma separated)"
            />
          ...
          <div className="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200/50">
            ...
            <Button
              ...
              loading={isLoading}
              disabled={!isValid}
              className="bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 shadow-lg shadow-purple-500/25 hover:shadow-purple-500/40 border-0 transition-all duration-200"
            >
